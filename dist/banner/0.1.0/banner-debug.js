...
MIT Licensed
build time: 2014-12-05 16:12:11 
*/
/*
 * banner
 * https://github.com/dreamstu/Qs
 *
 * Copyright (c) 2014 dreamstu
 * Licensed under the MIT license.
 */
define("gallery/banner/0.1.0/banner-debug", [], function(require, exports, module) {
    module.exports = function(jQuery) {
        (function(g) {
            ...
            g.jcarousel = function(a, c) {
                ...
                this.clip = this.list.parents(".jcarousel-clip"), this.container = this.list.parents(".jcarousel-container")) : (this.container = g(a), 
            ...
            f.fn.extend({
                ...
                pos: function(a, c) {
                    ...
                    for (var d = this.first > a, g = this.options.wrap != "circular" && this.first <= 1 ? 1 : this.first, j = d ? this.get(g) : this.get(this.last), e = d ? g : g - 1, h = null, i = 0, k = !1, l = 0; d ? --e >= a : ++e < a; ) {
                        ...
                        j[d ? "before" : "after"](h), this.first !== null && this.options.wrap == "circular" && this.options.size !== null && (e <= 0 || e > this.options.size))) j = this.get(this.index(e)), 
                    ...
                    i > 0 && (this.list.css(this.wh, this.dimension(this.list) + i + "px"), d && (b -= i, 
                ...
                buttons: function(a, c) {
                    ...
                    !this.locked && (!this.options.wrap || this.options.wrap == "first") && this.options.size !== null && this.last >= this.options.size)) a = this.tail !== null && !this.inTail;
                    if (c == null && (c = !this.locked && this.options.size !== 0 && (this.options.wrap && this.options.wrap != "last" || this.first > 1), 
                    !this.locked && (!this.options.wrap || this.options.wrap == "last") && this.options.size !== null && this.first == 1)) c = this.tail !== null && this.inTail;
                    var b = this;
