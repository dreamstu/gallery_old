 ...
 */
define("gallery/core/0.1.1/core-debug", [ "json2map/1.0.0/index-debug", "template/1.0.0/index-debug", "gallery/dialog/0.1.0/dialog-debug", "status/1.0.1/index-debug", "jsons/1.0.0/index-debug" ], function(require, exports, module) {
    var Json2Map = require("json2map/1.0.0/index-debug");
    var Template = require("template/1.0.0/index-debug");
    var Dialog = require("gallery/dialog/0.1.0/dialog-debug");
    var Status = require("status/1.0.1/index-debug")(Dialog);
                ...
                attrs = $.extend(true, {
                    success: function(rst) {
                        Status.check(rst, function() {
                            ...
                            require.async("verify-debug", function(Verify) {
