 ...
 */
define("gallery/dialog/0.1.0/dialog-plus", [ "jquery", "./dialog", "./popup", "./dialog-config", "./drag" ], function(require) {
    var $ = require("jquery");
 ...
 * For details, see: http://www.gnu.org/licenses/lgpl-2.1.html
 */
define("gallery/dialog/0.1.0/dialog", [ "jquery", "./popup", "./dialog-config" ], function(require) {
    var $ = require("jquery");
 ...
 * For details, see: http://www.gnu.org/licenses/lgpl-2.1.html
 */
define("gallery/dialog/0.1.0/drag", [ "jquery" ], function(require) {
    var $ = require("jquery");
    var $window = $(window);
...
(function(a, b) {
    ...
    }), a.jQuery = a.$ = f, typeof define == "function" && define("jquery", [], function() {
        return f;
    });
})(window);
 ...
 * For details, see: http://www.gnu.org/licenses/lgpl-2.1.html
 */
define("gallery/dialog/0.1.0/popup", [ "jquery" ], function(require) {
    var $ = require("jquery");
    var _count = 0;
    var _isIE6 = !("minWidth" in $("html")[0].style);
    var _isFixed = !_isIE6;
